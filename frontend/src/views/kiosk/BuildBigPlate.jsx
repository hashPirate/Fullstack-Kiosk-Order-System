...
// NOTE: logic is essentially the same for BuildBowl, BuildDrink, BuildPlate, and BuildBigPlate.
//       In the future, I need to make these more modular.
export default function BuildBigPlate() {
    ...
    return (
        <div id="kioskBuildPlate">
            ...
            <Collapsible detailsClasses="menuPartCollapsible" summary="Select Second Side">
                {renderMenuParts(sel4Parts, part4, setPart4)}
            </Collapsible>

            {/* DEBUG ONLY, delete this <p> later! */}
            <p>[DEBUG]: selected parts: {[part1, part2, part3, part4].filter(item => item !== "").join(", ")}</p>
