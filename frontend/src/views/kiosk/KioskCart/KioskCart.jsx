 ...
 * @returns {JSX.Element} Cart interface including item list and checkout button.
 */
export default function KioskCart() {
    ...
    if (loading) {
        return <HashLoader color={"#DC143C"} cssOverride={{"display": "block", "margin": "4rem auto"}} aria-label="Loading cart..." />;
    } else {
        return (
